    ...
    <div className="pt-20">
      <section className="py-24 bg-emerald-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">Lawn Care & Maintenance</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row-reverse gap-16 items-center">
            <div className="lg:w-1/2">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Pristine Green Maintenance</h2>
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
                A healthy lawn is the foundation of any great landscape. Our turf management programs are scientifically designed to promote thick, resilient growth while suppressing weeds and preventing disease.
              </p>
